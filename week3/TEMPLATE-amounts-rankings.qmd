...
ca_region |> 
  ...
  ggplot(aes(y = subregion_name, x = mean_sui_2010_2020)) +
  geom_col() +
  geom_text(aes(label = round(mean_sui_2010_2020, 2)), color = "white", hjust = 1.2)
...
ca_region |> 
  ...
  geom_text(aes(label = round(mean_sui_2010_2020, 2)), color = "black", hjust = -0.3) +
